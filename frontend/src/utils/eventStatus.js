// Single source of truth for event lifecycle status (frontend).
// Mirrors backend/utils/eventStatus.js exactly. All lifecycle decisions are
// made in Asia/Kolkata (IST) regardless of the viewer's own timezone: we
// shift the instant by the fixed IST offset and read it back with the UTC
// getters, which gives deterministic IST wall-clock values on any device.
 ...
 * Keep this in sync with backend/utils/eventStatus.js.
 *
